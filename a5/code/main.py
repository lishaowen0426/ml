...
if __name__ == '__main__':
    ...
    if question == '2':
        ...
        utils.savefig('PCA_features.png')

        Xhat = model.expand(Z)
        var_remaining = norm(Xhat - X, ord = 'fro')/ norm(X, ord = 'fro')
        print('variance explained by k = 2: %.3f' %(1-var_remaining))
        ...
        for k in range(3, d):
            ...
            if var_remaining <= 0.5:
                break

        print('variance explained by k = %d : %.3f' %(k,1-var_remaining))
